...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://vivisshbr.xyz/CrashVPN/main/versao
...
echo -e "                              \033[1;31mSSHPLUS\033[1;36m"
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  echo -e " \033[1;33m MAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@vivi016\n"
  ...
  echo -e "  \033[1;33mMAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@vivi016\n"
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget https://vivisshbr.xyz/CrashVPN/main/crashvpn > /dev/null 2>&1
