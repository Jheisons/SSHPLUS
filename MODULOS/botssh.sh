...
fun_botOnOff() {
    [[ $(ps x | grep "bot_plus" | grep -v grep | wc -l) = '0' ]] && {
        clear
        echo -e "\E[44;1;37m             INSTALADOR BOT                \E[0m\n"
        ...
        fun_bot1() {
            [[ ! -e "/etc/CrashVPN/ShellBot.sh" ]] && wget https://vivisshbr.xyz/CrashVPN/main/ShellBot.sh -O /etc/CrashVPN/ShellBot.sh
            cd /etc/CrashVPN
			rm -R bot
			wget https://vivisshbr.xyz/CrashVPN/main/Modulos/bot
			chmod 777 bot
        ...
        fun_bar 'fun_bot2'
        echo -e "\n\033[1;32m \033[1;31mBOT PARADO! \033[0m"
        sleep 2
        menu
    }
}
