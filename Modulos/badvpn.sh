...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://github.com/Jheisons/SSHPLUS/raw/main/Install/badvpn-udpgw -o /dev/null
			wget https://github.com/Jheisons/SSHPLUS/raw/main/Modulos/antcrashvpn.sh -o /dev/null
